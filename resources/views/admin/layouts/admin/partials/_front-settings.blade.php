                        ...
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/layouts-sidebar-default.svg"
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/layouts-sidebar-dark.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/layouts-sidebar-light.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/sidebar-default-classic.svg"
                                     alt="Image Description">
                            </label>
                            <span class="custom-checkbox-card-text">Default</span>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/sidebar-compact.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/sidebar-mini.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions1">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/header-default-fluid.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions2">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/header-default-container.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions3">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/header-double-line-fluid.svg"
                                     alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
                                <img class="custom-checkbox-card-img"
                                     src="{{asset(config('app.static') . '/admin')}}/svg/layouts/header-double-line-container.svg"
                                     alt="Image Description">
                            </label>
