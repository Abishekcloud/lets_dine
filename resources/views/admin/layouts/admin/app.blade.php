                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center">
                                ...
                                <hr>
                                <button class="btn btn-warning mr-3 ignore-order">{{__('messages.Ignore for now')}}</button>
                                <button class="btn btn-primary check-order">{{__('messages.Ok, let me check')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<span id="message-send-successfully" data-text="{{ __('messages.Okay') }}"></span>
